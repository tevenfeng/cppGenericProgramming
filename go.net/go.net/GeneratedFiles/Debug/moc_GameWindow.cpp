...
QT_MOC_LITERAL(1, 11, 15), // "gameWindowClose"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 11), // "chessAction"
QT_MOC_LITERAL(4, 40, 6), // "string"
QT_MOC_LITERAL(5, 47, 4) // "data"

    },
    "GameWindow\0gameWindowClose\0\0chessAction\0"
    "string\0data"
};
...
void GameWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->chessAction((*reinterpret_cast< string(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameWindow::gameWindowClose)) {
                *result = 0;
                return;
            }
        }
